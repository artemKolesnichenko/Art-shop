...
const accordion = triggesrSelector => {
  const btns = document.querySelectorAll(triggesrSelector);
  btns.forEach(btn => {
...
const drop = () => {
  ...
  function highlight(item) {
    item.closest('.file_upload').style.border = "1.5px solid yellow";
  ...
  links.forEach(link => {
    link.addEventListener('click', function (e) {
      ...
      function step(time) {
        ...
        document.documentElement.scroll(0, r);
